...
async def async_setup_entry(hass, entry, async_add_entities):
    ...
    programs = await rainmachine.controller.programs.all(include_inactive=True)
...
class RainMachineProgram(RainMachineSwitch):
    ...
    async def async_turn_off(self, **kwargs) -> None:
        ...
        try:
            await self.rainmachine.controller.programs.stop(self._rainmachine_entity_id)
...
class RainMachineZone(RainMachineSwitch):
    ...
    async def async_turn_off(self, **kwargs) -> None:
        ...
        try:
            await self.rainmachine.controller.zones.stop(self._rainmachine_entity_id)
        except RequestError as err:
    ...
    async def async_update(self) -> None:
        ...
        try:
            ...
            self._properties_json = await self.rainmachine.controller.zones.get(
